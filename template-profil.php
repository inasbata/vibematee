            ...
            <div class="col-12 col-lg-3 profil-sidebar">
                <div class="sidebar-content">
                    ...
                    <nav class="sidebar-nav">
                        ...
                        <a href="<?php echo esc_url(get_securite_page_url()); ?>" class="nav-item">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="nav-icon">
                    ...
                    <form class="profil-form">
                        ...
                        <div class="form-group gender-selection">
                            <div class="gender-buttons">
                                <button type="button" class="gender-btn active" data-gender="homme">Homme</button>
                                <button type="button" class="gender-btn" data-gender="femme">Femme</button>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="row g-2">
                                <div class="col-4">
                                    <input type="text" class="form-control" placeholder="Jour" name="birth_day" />
                                </div>
                                <div class="col-4">
                                    <input type="text" class="form-control" placeholder="Mois" name="birth_month" />
                                </div>
                                <div class="col-4">
                                    <input type="text" class="form-control" placeholder="Année" name="birth_year" />
                                </div>
                            </div>
                        </div>
