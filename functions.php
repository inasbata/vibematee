...
{
    // Enqueue Typekit font
    wp_enqueue_style('typekit-font', 'https://use.typekit.net/pqf5evt.css', array(), null);
    // Enqueue Bootstrap CSS
    wp_enqueue_style('bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.min.css', array(), '5.3.8');
    wp_enqueue_style('theme-style', get_template_directory_uri() . '/assets/css/main.css', array('typekit-font', 'bootstrap'), '1.0.0');
    
    // Enqueue Events CSS only on Events template
